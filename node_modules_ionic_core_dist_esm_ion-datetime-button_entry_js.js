...
const DatetimeButton = class {
  constructor(hostRef) {
     ...
     */
    this.waitForDatetimeChanges = /*#__PURE__*/(0,_Users_ramanujkayal_Documents_office_project_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const {
        datetimeEl
      } = _this;
      if (!datetimeEl) {
    ...
    this.presentOverlay = /*#__PURE__*/function () {
      var _ref3 = (0,_Users_ramanujkayal_Documents_office_project_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev, needsPresentationChange, triggerEl) {
        const {
          overlayEl
        } = _this;
        if (!overlayEl) {
